...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQuerryChan(new FloatingSearchView.OnQueryChangeListener() {
            @Override
    ...
    private List<CatatanModel> fileData(List<CatatanModel> dataCatatan, String newQuery) {
